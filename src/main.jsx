...
function LoginScreen({ onLogin }) { /* ...código do LoginScreen (sem alterações)... */ }
...
function App() {
  ...
  const handleDelete = async (type, id) => { /* ...código de deletar (sem alterações)... */ };
  const handleApproveBudget = async (budgetToApprove) => { /* ...código de aprovar (sem alterações)... */ };
